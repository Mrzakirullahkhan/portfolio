...
const portfolio = {
  meta: {
    name: "Zakir Ullah",
    github: "https://github.com/Mrzakirullahkhan/portfolio",
    linkedin: "https://www.linkedin.com/in/zakir-ullah-khan-a5535426a/",
...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-cyan-500/30 bg-black overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <p className="text-gray-400 text-sm">
              ...
              <span className="font-semibold bg-gradient-to-r from-cyan-400 to-orange-500 bg-clip-text text-transparent">
                {portfolio.meta.name}
              </span>
              . All rights reserved.
            </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-6 h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent"
        />
      </div>
    </footer>
  );
